...
const qrItems = [
  ...
  ['Interactive Streamlit prototype', 'Explore the Random Forest model interface.', data.links.prototype, 'assets/qr/streamlit.png'],
...
// Version 6.0 uses the supplied circular particle visual. No human-head overlay is rendered.
if (typeof BrainAnimation !== 'undefined' && window.d3) {
  BrainAnimation.init('#brain-dots', { width: 800, height: 800, particleCount: 150, backgroundColor: '#ffffff' });
}
