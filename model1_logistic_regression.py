...
from neumorphic_visualizations import save_confusion_matrix  ## draws the styled confusion matrix
...
MODEL2_PATH = PROJECT_ROOT / "src" / "model2_decision_tree_TODO_GUIDE.py"  ## checked for "is it done yet?"
...
def evaluate(X, y):
    ...
    return lr_pred, lr_metrics, impaired_caught, impaired_total
...
def main():
    ...
    y_pred, lr_metrics, impaired_caught, impaired_total = evaluate(X, y)
