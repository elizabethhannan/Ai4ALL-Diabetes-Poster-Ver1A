...
const qrItems = [
  ...
  ['Slide presentation', 'Replace this destination in data.js before publication.', data.links.slides],
  ['Group 6C Prototype App', 'Placeholder for the shared Group 6C prototype application.', data.links.groupPrototype]
];
