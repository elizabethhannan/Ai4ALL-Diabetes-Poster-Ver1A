    ...
    key_panel(
        {
            ...
            "Macro F1": "Average balance of precision and recall across both cognitive-status classes.",
...
with gauge_cols[1]:
    ...
    visual_notes(
        ...
        [
            "This checks whether performance is balanced.",
...
with right:
    ...
    st.markdown(
        """
        Model 1 uses 5-fold stratified cross-validation with preprocessing inside
        each fold. The impaired-recall metric tracks how many mild-impairment
