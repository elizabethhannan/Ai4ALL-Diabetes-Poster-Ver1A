    ...
    key_panel(
        {
            ...
            "Macro F1": "Class-balanced score for judging both no-impairment and impaired predictions.",
...
with gauge_cols[1]:
    ...
    visual_notes(
        ...
        [
            "This checks balance across the two groups.",
...
with right:
    ...
    st.markdown(
        """
        Model 2 is the interpretable decision-tree model. Its diagram shows the
        learned split rules, while impaired recall tracks how many mild-impairment
        cases the model catches.
        """
    )
